...
best-effort raises a display-only desktop toast (no click-through). A sink only
delivers a rendered template — it emits nothing back into the pipeline and never
